...
const StrangerThingsCharacters = memo(() => {
  ...
  return (
    <>
      {/* Vecna - Right side */}
      <motion.div
        className="fixed right-0 top-1/4 z-20 pointer-events-none will-change-transform"
        style={{ y: vecnaY, opacity: vecnaOpacity }}
      >
        <motion.img
          src={vecna}
          alt=""
          className="w-[300px] md:w-[400px] lg:w-[500px] h-auto object-contain opacity-40 will-change-[filter]"
          style={{
      ...
      <motion.div
        className="fixed left-0 bottom-0 z-20 pointer-events-none will-change-transform"
